...
<template>
  <section class="py-20 bg-slate-50 text-slate-800">
    <div class="max-w-7xl mx-auto px-6 md:px-12">
      ...
      <div v-if="tematicas.length > 0" class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div class="lg:col-span-7 bg-white p-6 md:p-8 rounded-2xl border border-slate-200 shadow-sm flex flex-col justify-between min-h-[400px]">
          <div class="space-y-6">
            ...
            <ul v-if="tematicas[temaActivo]" class="space-y-3">
              <li 
          ...
          <div v-if="tematicas[temaActivo]" class="mt-8 rounded-xl overflow-hidden h-44 bg-slate-100 border border-slate-100">
            <img 
      ...
      <div v-else class="text-center py-12 text-slate-400 text-sm">
        Cargando temáticas y proyectos...
      </div>

<template>
  <div class="space-y-6 animate-fade-in">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
      <div>
        <h2 class="text-xl font-black text-slate-900">Voluntarios y Usuarios Registrados</h2>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
      ...
      <div class="bg-white border border-slate-200 p-5 rounded-2xl flex items-center justify-between shadow-2xs">
        <div>
          <span class="text-[10px] font-black text-slate-400 uppercase tracking-wider block">Miembros Oficiales</span>
    ...
    <div class="p-4 rounded-xl bg-white border border-slate-200 shadow-2xs">
      <div class="relative max-w-md w-full">
        ...
        <input 
          v-model="searchQuery" 
          type="text" 
          placeholder="Buscar voluntario por nombre o correo..." 
        ...
        <table class="w-full text-left text-sm">
          <thead>
            <tr class="border-b border-slate-200 bg-slate-50 text-slate-500 font-black text-[10px] uppercase tracking-wider">
              ...
              <th class="p-4">Rol</th>
              <th class="p-4">Actividades</th>
              <th class="p-4">Miembro Oficial</th>
